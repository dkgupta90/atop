...
int main()
{
	try{
		...
		if(topopt2d.model_problem == 1){
			...
			topopt2d.y_count = 1;
			topopt2d.nq = 2;
			topopt2d.init_density = 1;
			topopt2d.den_choice =0;
		}
