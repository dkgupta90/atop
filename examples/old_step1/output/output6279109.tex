...
Results generated  on Fri Jun 26 11:28:53 2015
\\File Access code : 6279109\\ 
--------------------------------------------------------\\ 
...
table[x=iter,y=penal] {obj_output6279109.dat}; 
\end{axis}  
\end{tikzpicture}  
\end{subfigure}  
\hfill  
...
\addplot[scatter, mark=*, mark size=1, gray, point meta = \thisrow{cycle} ] 
table[x=iter,y=obj] {obj_output6279109.dat}; 
\end{axis}  
\end{tikzpicture}  
\end{subfigure}  
\end{figure}  
