...
Results generated  on Fri Jun 26 11:27:24 2015
\\File Access code : 7469152\\ 
--------------------------------------------------------\\ 
...
table[x=iter,y=penal] {obj_output7469152.dat}; 
\end{axis}  
\end{tikzpicture}  
\end{subfigure}  
\hfill  
...
\addplot[scatter, mark=*, mark size=1, gray, point meta = \thisrow{cycle} ] 
table[x=iter,y=obj] {obj_output7469152.dat}; 
\end{axis}  
\end{tikzpicture}  
\end{subfigure}  
\end{figure}  
